  ...
  return (
    <footer className="bg-blue-200 p-4 mt-20">
      <div className="container max-w-[1024px] p-4 m-auto">
        <section className="flex items-center flex-1 justify-between border-b-2 pb-5 border-blue-50"> 
        ...
        <section className="flex justify-between my-10">
          {[1, 2, 3, 4].map(() => (
            <div>
              ...
              <ul>
                <li><a href="#" className="text-base text-blue-600 hover:underline">Home</a></li>
                <li><a href="#" className="text-base text-blue-600 hover:underline">Home</a></li>
                <li><a href="#" className="text-base text-blue-600 hover:underline">Home</a></li>
                <li><a href="#" className="text-base text-blue-600 hover:underline">Home</a></li>
                <li><a href="#" className="text-base text-blue-600 hover:underline">Home</a></li>
